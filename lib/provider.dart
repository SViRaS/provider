...
//           FutureProvider(create: (_) async => UserProvider().loadUserData(), initialData: [],),
...
//         ),
//         Consumer<List<User>>(builder: (context, List<User> users, _) => Expanded(
//           child: users == null ? Container(child: Center(child: Text("don't, noob"
//           ))) :
//            ListView.builder(
...
//   @override
//   Widget build(BuildContext context) {
//     var _provider = Provider.of<int>(context);
//     return Center(
//         child: Column(
//       mainAxisAlignment: MainAxisAlignment.center,
//       children: [
...
//         const SizedBox(height: 50),
//         Text('${_provider.toString()}', style: Theme.of(context).textTheme.headline4)
//       ],
//     ));
//   }
// }
